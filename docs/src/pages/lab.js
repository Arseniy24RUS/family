...
export async function lab(ctx) {
    ...
    if (tab === 'correlation') {
        ...
        const resultBox = h('div', {}, empty('Расчёт ещё не выполнен', 'Выберите признаки и число групп. Используются последние доступные периоды каждого источника; даты входов показаны отдельно.')), periodBox = h('div', {});
